...
show tables;
-- 1. print all rows and columns from the dataset
describe customer;
describe order_line;
describe orders;
describe part;
...
-- 4. Select only 2 rows from order_line
...
-- The smallest number ordered for these conditions is 2 not 1 so #7 shows no output.
